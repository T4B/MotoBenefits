...
<div class="page-title"> <i class="icon-bar-chart"></i>
  <h3><span class="semi-bold">Ventas Canal Directo</span></h3>
</div>
		...
		<div id="survey_container">
			...
			<form action="#">
				<fieldset style="border: 0px;">
					...
					<a href='ventas_canal_directo.csv'><button type="button" style="background-color: #4AAD79; color: white; border: 0px;">Descargar archivo</button></a>
				</fieldset>
			</form>	

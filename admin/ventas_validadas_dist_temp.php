...
$lista=$users->lista_usuarios_dist_temp();
...
<div class="page-title"> <i class="icon-bar-chart"></i>
  <h3><span class="semi-bold">Temporales Canal Alterno</span></h3>
</div>
	<div id="container">
		...
		<div id="survey_container">
			...
			<form action="#">
				<fieldset style="border: 0px;">
					...
					<!--<a href='solicitadas_final_dist.csv'><button type="button" style="background-color: #4AAD79; color: white; border: 0px;">Descargar archivo</button></a>-->
				</fieldset>
			</form>	

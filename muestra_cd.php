...
<meta name="description" content="Dignity by Designova - Responsive HTML5 template">
...
<nav class="menu visible-xs visible-sm visible-md" id="sm">
	<div class="sm-wrap">
		...
		<a href="https://www.moto-benefits.com.mx/admin">REGRESAR</a>
	</div>
...
<header id="masthead" class="clearfix">
	...
	<ul class="standard-nav visible-lg">
		...
		<li><a id="contact-linker" href="https://www.moto-benefits.com.mx/admin">REGRESAR</a></li>
	</ul>
</header>
<!-- MENÚ : FIN -->
